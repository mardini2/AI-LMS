...
import { mapProviderError, assertNonEmptyText } from './provider.errors';
import { isAiProviderId, AI_PROVIDER_IDS } from './provider.types';
...
function buildRegistry(flags: Partial<Record<AiProviderId, boolean>>) {
